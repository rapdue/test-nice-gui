...
python main.py</pre>
        ...
        <div style="text-align: center; margin: 20px 0;">
            <a href="https://github.com/rapdue/test-nice-gui" class="github-link">
...
## 🌐 Live Demo
[Hier ansehen](https://rapdue.github.io/test-nice-gui/)

## 📁 Originales Repository
Das vollständige NiceGUI-Projekt finden Sie im [Haupt-Repository](https://github.com/rapdue/test-nice-gui).
